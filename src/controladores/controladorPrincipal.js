...
const db = require('../conexiones_db/conexionMySQL'); // Asegúrate de tener la conexión a la base de datos
...
// Controlador para mostrar el formulario de departamento
exports.departamento = async (req, res) => {
    try {
        const [paises] = await db.query('SELECT Id_Pais, Nombre FROM Pais');
        res.render('Departamento', { paises: paises });
    } catch (error) {
